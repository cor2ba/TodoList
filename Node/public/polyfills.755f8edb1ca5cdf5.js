    ...
    583: () => {
        ...
        let d = (() => {
          class M {
            ...
            runTask(t, r, k) {
              ...
              const C = t.state != p;
              C && t._transitionTo(p, A), t.runCount++;
              const $ = re;
        ...
        class t {
          ...
          then(u, s) {
            ...
            const b = new g(M),
              T = n.current;
            return (
              this[q] == A ? this[R].push(T, b, u, s) : ee(this, T, b, u, s), b
            );
          }
          catch(u) {
            ...
            const b = n.current;
            return (
              this[q] == A ? this[R].push(b, g, u, u) : ee(this, b, g, u, u), g
            );
          }
        }
        (t.resolve = t.resolve),
      ...
      function dt(e, n, i, o) {
        ...
        function J(R, _) {
          ...
          _ && _.prepend && (z = p[j(_.prepend)] = p[_.prepend]);
          const t = K
              ? function (s) {
                  if (!h.isExisting)
                    return I.call(
          ...
          !(function P(v) {
            ...
            const K = le(
              ...
              p = le(
                ...
                () =>
                  function (h, I) {
                    if (!0 === n.current[A] || h[o]) return p.apply(h, I);
                    {
                      const w = {
                          target: h,
                          url: h[y],
